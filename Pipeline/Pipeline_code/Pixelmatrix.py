...
# === CONFIGURATION ===
# === PATHS (relative) ===
csv_path = "Pipeline_data/Predicted_keypoints.csv"
image_folder = os.path.join("Pipeline_data", "Clean data", "Overbite Data" )
output_csv_path = "Pipeline_data/Output_after_pixel_matrix/Predicted_keypoints_pixel_matrix.csv"
...
for idx, row in tqdm(df.iterrows(), total=len(df)):
    ...
    output_html_dir = os.path.join("Pipeline_data", "Output_after_pixel_matrix")
